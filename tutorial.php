...
<html>
    ...
    <div class="row">
        <div class="col s12 l12">
            ...
            <ul>
                <li><i class="material-icons tiny">flag</i> <b><em>(Perfil Master)</em></b> Cadastros -> Empresas -> Adicionar Empresa - consiste em criar uma nova empresa no sistema, equivalente ao cadastro de um novo cliente. Clique <a href="https://youtu.be/zqw9Yu8uxnI" target="_blank">aqui</a> e veja como cadastrar uma nova empresa;</li>
                <li><i class="material-icons tiny">flag</i> <b><em>Perfil Master)(Perfil Administrador - após ser cadastrado/vinculado à nova empresa)</em></b> Cadastros -> Usuarios -> Novo - consiste em adicionar um novo usuário, vinculando a uma empresa já existente, definindo sua área e seu perfil de acesso. Todo usuário criado é marcado como "inativo", devendo o mesmo ser "ativado" logo após o cadastro. Clique <a href="https://youtu.be/z49lF3O0Y8k" target="_blank">aqui</a> e veja como cadastrar um novo usuário;</li>
                <li><i class="material-icons tiny">flag</i> <b><em>(Perfil Master)(Perfil Administrador)</em></b> Cadastros -> Tipos de item - consiste em criar novos itens passíveis de solicitação de reembolso. Clique <a href="https://youtu.be/h9tNJVpe8Xw" target="_blank">aqui</a> e veja como cadastrar um novo item;</li>
                <li><i class="material-icons tiny">flag</i> <b><em>(Todos os perfis)</em></b> Pedidos -> Novo Pedido - consiste em registrar um pedido de reembolso, devendo o solicitante registrar o período da viagem, uma justificativa, um destino, e adicionar as informações de cada despesa desta viagem, sendo cada item (combustível, hospedagem, etc. ) um registro de item. Clique <a href="https://youtu.be/YhOJeuGks8g" target="_blank">aqui</a> e veja como solicitar um pedido de reembolso, bem como identificar como funcionam os fluxos de aprovação;</li>
                <li><i class="material-icons tiny">flag</i> <b><em>(Todos os perfis)</em></b> Pedidos -> Consulta pedidos - exibe (conforme perfil) todos os pedidos já efetuados, independentemente do status atual, sendo passível de filtros. Clique <a href="https://youtu.be/LuyayF8Y3Gg" target="_blank">aqui</a> e veja como consultar pedidos;</li>
                <ul>
                ...
                <li><i class="material-icons tiny">flag</i><b><em>(Perfil Administrador)(Perfil Master)</em></b> Logs - consiste em exibir as ações realizadas em cada análise de pedido, informando data/hora, usuário que realizou, tipo de ação, e acesso ao pedido consultado. Clique <a href="https://youtu.be/B4s6bV92Ciw" target="_blank">aqui</a> e veja como visualizar os registros de ações dos pedidos.</li>        
            </ul>
        </div>
    </div> 
    <div class="row">
